---
name: add-reference
description: Register files, URLs, or background knowledge as workspace references that help skills perform better
...
- **Description** — one-line summary of what it is and how it helps skills
- **Added** — date added
...
If the `## Reference Sources` section doesn't exist yet, create it in user settings (before `## Skill-Specific Settings`).
...
>
> Claude will now use this as background knowledge to make your skills better.
