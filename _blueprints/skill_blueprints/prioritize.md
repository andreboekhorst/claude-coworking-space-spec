...
A structured ranking skill that turns a messy backlog into an ordered list. Makes trade-offs visible so the user can commit to a sequence with confidence.
